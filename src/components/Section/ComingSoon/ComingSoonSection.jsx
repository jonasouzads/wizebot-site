    ...
    <>
      <div className="section wizebot-extra-section">
        <div className="container">
          ...
          <div className="wizebot-countdown-wrap">
            <div className="wizebot-countdown-item">
          ...
          <form action="#">
            <div className="wizebot-coming-newsletter">
              <input type="email" placeholder="Enter your email" />
              <button type="submit" id="wizebot-notified-btn">
                Get Notified
              </button>
              <p>
      ...
      <footer class="wizebot-footer-section main-footer">
        <div class="container">
          <div class="wizebot-footer-bottom border-0">
            <div class="wizebot-social-icon order-md-2">
              <ul>
                <li>
